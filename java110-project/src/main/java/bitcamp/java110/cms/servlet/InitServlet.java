...
public class InitServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        //서블릿에서 DAO를 사용할 수 있도록 ServletContext보관소에 저장
...
//=> 그래서 service(), doGet(), doPost() 등 메서드를 구현하지 않는다.
//=> 클라이언트가 요청하지 않아도 이 서블릿 객체가 생성되고 init()가 실행되어야 하기 때문에
