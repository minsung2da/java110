...
// 웹 애플리케이션이 시작되거나 종료되는 상황일 때 실행디는 리스너 만들기
...
public class Listener01 implements ServletContextListener {
    ...
    public void contextDestroyed(ServletContextEvent sce) {
        // 웹 어플리케이션이 종료될 때 이 메서드가 호출된다
        //contextInitialized()에서 준비했던 지원을 해제시킨다.

      System.out.println("Lietener01.contextDestroyed");
