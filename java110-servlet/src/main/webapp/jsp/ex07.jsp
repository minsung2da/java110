...
pageEncoding 속성
  - JSP 엔진에게 JSP 파일이 어떤 문자표를 사용하여 인코딩했는지 알려준다.   
...
buffer 속성
  ...
  - 기본 값은 8kb이다.
  - 만약 buffer 크기를 초과하면 autoFlush의 설정에 따라 처리된다.
    autoFlush가 만약에 true이면 (autoFlush = "true")
      - 버퍼를 초과하는 순간 클라이언트로 즉시 출력된다.     
    autoFlush가 만약에 false이면 (autoFlush = "false")
