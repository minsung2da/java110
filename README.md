...
-작업
  - 프론트 컨트롤러(DispatcherServlet)을 변경한다.
  - 

## v6.4

- CRUD 기능을 합쳐 한 개의 페이지 컨트롤러로 만들기
  - CRUD를 처리하는 각 메서드의 크기가 크지 않다면 관리하기 쉽게 
    한개의 클래스로 통합한다.
- 작업
...
-트랜잭션 관리하기
-작업
  - 트랜잭션으로 위해 DataSource의 Connection을 관리하는 클래스를 작성한다.
...
## v4.1
-서블릿의 loadOnStart 배치 속성을 이용하여 공용 자원을 준비하기
- ServletContext를 이용하여 공용자원을 공유하기
-작업
 + InitServlet 클래스 생성
 + InitServlet 에서 DAO와 DataSource 준비하기 
 + ServletContext에 DAO 저장하기
