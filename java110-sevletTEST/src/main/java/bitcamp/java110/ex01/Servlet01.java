...
// 2)웹 에플리케이션의 경로를 web01로 설정했을 경우,
// http://localhost:8888/web01/ex01/servlet01

// 3)웹 어플리케이션의 경로를 별도로 지정하지 않앗을 경우,
// http://localhost:8888/java110-servlet/ex01/servlet01
// 즉 웹 어플리 케이션 이름 자리에 프로젝트 이름을 사용한다.
...
public class Servlet01 implements Servlet{
    ...
    public void init(ServletConfig config) throws ServletException {
       ...
       //또는 서블릿에서 사용할 서비스 객체나 DAO객체를 준비하는 일을 한다.
    ...
    public ServletConfig getServletConfig() {
        ...
        // 그래서 이 메서드는 init()에서 파라미터로 받은 ServletConfig의 객체를
        // 잘 보관해 두었다가 호출 될 때 리턴해야 한다.
        return this.config;
    }
